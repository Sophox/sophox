...
from .Properties import P_INSTANCE_OF, P_KEY_ID, P_TAG_ID, P_TAG_KEY, P_KEY_TYPE, Property, P_LANG_CODE, Qualified
    ...
    def validate_data_item(self):
        ...
        if instance_of == Q_KEY or key_strid or \
            ...
            if not instance_of:
                ...
                self.claims[P_INSTANCE_OF] = [Qualified(Q_KEY)]
            ...
            if not key_strid:
                ...
                self.claims[P_KEY_ID] = [Qualified(self.strid)]
            elif '=' in key_strid:
            ...
            if len(related_tags) > 5 and key_strid not in known_non_enums:
                self.claims[P_KEY_TYPE] = [Qualified(Q_ENUM_KEY_TYPE)]
        ...
        if instance_of == Q_TAG or tag_strid or \
            ...
            if not instance_of:
                ...
                self.claims[P_INSTANCE_OF] = [Qualified(Q_TAG)]
            ...
            if not tag_strid:
                ...
                self.claims[P_TAG_ID] = [Qualified(self.strid)]
            ...
            if not tag_key:
                ...
                if expected_tag_key:
                    self.claims[P_TAG_KEY] = [Qualified(expected_tag_key)]
                else:
